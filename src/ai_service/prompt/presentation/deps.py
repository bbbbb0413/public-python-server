...
from ai_service.prompt.application.deactivate_active_prompt_use_case import (
    DeactivateActivePromptUseCase,
)
...
def get_deactivate_active_prompt_use_case(
    repo: PromptTemplateRepositoryDep,
) -> DeactivateActivePromptUseCase:
    return DeactivateActivePromptUseCase(repo)
...
DeactivateActivePromptUseCaseDep = Annotated[
    DeactivateActivePromptUseCase, Depends(get_deactivate_active_prompt_use_case)
]
