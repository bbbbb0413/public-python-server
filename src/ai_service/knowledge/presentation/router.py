...
from ai_service.knowledge.presentation.deps import DocumentRepositoryDep, VectorStoreDep
from ai_service.knowledge.presentation.dto import ChunkOut, DocumentOut
from ai_service.knowledge.presentation.guard import require_admin_api_key
